...
for i,correct in enumerate(correct[:9]):
  plt.subplot(3,3,i+1)
  plt.imsave("plot1.png",testX[correct].reshape(96,96), cmap='gray', interpolation='none')
...
for i, incorrect in enumerate(incorrect[:9]):
  plt.subplot(3,3,i+1)
  plt.imsave("plot1.png",testX[incorrect].reshape(96,96), cmap='gray', interpolation='none')
